...
-LIST OUT MISSING VALES FOR EACH OF THESE COLUMNS-
```{r}


```

There are a lot of columns where the overwhelming majority of values are NA. For the time-being, I am going to get rid of any column where there are fewer than 20% of the observations that have a real value. After that is carried out, I will remove any columns that have either low or near-zero variance, using caret's nearZeroVar() function. 
